...
class MomentumNet(nn.Module):
    ...
    def forward(self, x, \
        ...
        if refine_outputs:
            ...
            mask_ignore = torch.zeros(plabels.shape[0],plabels.shape[-1], plabels.shape[-2], dtype=bool)
            mask_ignore2 = torch.zeros(plabels.shape[0],plabels.shape[-1], plabels.shape[-2], dtype=bool)
